...
/************loop for extracting coordination from svg to pts (world) coordination  ******/
        ...
        getNextMove: function(pt){
            ...
            var offsetX = parseInt(this.options.startx, 10);
            var offsetY = parseInt(this.options.starty, 10);
            move.m1 = this.getDelta(this.state.x + offsetX, this.state.y + offsetY, pt.x + offsetX, pt.y + offsetY);
            move.m2 = this.getDelta(this.state.x - motDistance + offsetX, this.state.y + offsetY, pt.x - motDistance + offsetX, pt.y + offsetY);
